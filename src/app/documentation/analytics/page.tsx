    ...
    <div className="space-y-8">
      <div className="space-y-4">
        ...
        <p className="text-xl text-muted-foreground">
          Gain insights into your feature development process with comprehensive
      ...
      <div className="space-y-8">
        <section className="space-y-6">
          ...
          <div className="bg-muted p-6 rounded-lg">
            <p className="text-muted-foreground mb-4">
              Analytics provides valuable insights into your feature development
              workflow, team performance, and project progress. Use data-driven
              decisions to optimize your development process and improve team
              productivity.
            </p>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-6">
            <div className="border rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-muted-foreground mb-4">
                  Visualize the distribution of features across different
                  statuses to understand your development pipeline.
                </p>
            ...
            <div className="border rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-muted-foreground mb-4">
                  Track your team&apos;s development velocity over time to
                  identify trends and optimize your workflow.
                </p>
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 border rounded-lg">
              ...
              <p className="text-muted-foreground mb-4">
                Understand how time is spent across different phases of feature
                development.
              </p>
            ...
            <div className="p-6 border rounded-lg">
              ...
              <p className="text-muted-foreground mb-4">
                Analyze the distribution of different types of features in your
                pipeline.
              </p>
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
        ...
        <section className="space-y-6">
          ...
          <div className="bg-muted p-6 rounded-lg">
            <p className="text-muted-foreground mb-4">
              Create custom reports to track specific metrics that matter to
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="p-4 border-l-4 border-blue-500 bg-blue-50 rounded-r-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Identify bottlenecks in your development process by analyzing
                time spent in each status. Look for features that stay in one
            ...
            <div className="p-4 border-l-4 border-green-500 bg-green-50 rounded-r-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Monitor team productivity metrics to understand individual and
                collective performance. Use this data to optimize workload
                distribution and identify training needs.
              </p>
            </div>
            <div className="p-4 border-l-4 border-purple-500 bg-purple-50 rounded-r-lg">
              <h3 className="font-medium mb-2">Quality Metrics</h3>
              <p className="text-sm text-muted-foreground">
                Track quality indicators like rejection rates, rework frequency,
                and customer satisfaction to ensure your development process
            ...
            <div className="p-4 border-l-4 border-yellow-500 bg-yellow-50 rounded-r-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Use historical data to predict project completion times,
                resource needs, and potential risks. This helps with better
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="p-4 border-l-4 border-blue-500 bg-blue-50 rounded-r-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Schedule regular analytics reviews with your team to discuss
                trends, identify improvements, and celebrate achievements. Make
                data-driven decisions part of your workflow.
              </p>
            </div>
            <div className="p-4 border-l-4 border-green-500 bg-green-50 rounded-r-lg">
              <h3 className="font-medium mb-2">Set Benchmarks</h3>
              <p className="text-sm text-muted-foreground">
                Establish baseline metrics and set realistic goals for
                improvement. Track progress over time and adjust your processes
            ...
            <div className="p-4 border-l-4 border-purple-500 bg-purple-50 rounded-r-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Don&apos;t just collect data - use it to make informed
                decisions. Focus on metrics that directly impact your
                team&apos;s productivity and product quality.
              </p>
            </div>
            <div className="p-4 border-l-4 border-yellow-500 bg-yellow-50 rounded-r-lg">
              <h3 className="font-medium mb-2">Share with Stakeholders</h3>
              <p className="text-sm text-muted-foreground">
                Share relevant analytics with stakeholders to demonstrate
                progress and value. Use visual reports to make complex data
