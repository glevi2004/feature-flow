  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 pt-20">
        ...
        <section
          id="workflow"
          className="bg-gray-50 dark:bg-gray-800 py-20 scroll-mt-20"
        >
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-4">
                How Feature Flow Works
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                A streamlined workflow from feedback collection to
                implementation
              </p>
            </div>
                ...
                <div className="space-y-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        Users submit feedback through widgets, portals, surveys,
                        and integrations
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        AI categorizes and groups duplicate feedback
                        automatically
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        Users upvote, comment, and answer follow-up questions
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        Filter by revenue impact, customer segment, and
                        importance
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg mb-2">Prioritize</h3>
                      <p className="text-gray-600 dark:text-gray-300">
                        Use frameworks and visual tools to prioritize features
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        Share updates, changelogs, and notify users of
                        implementations
                      </p>
                    </div>
                  </div>
